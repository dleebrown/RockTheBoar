...
#get_ipython().system(u'ls ../input/train/ | wc -l')
#get_ipython().system(u'ls ../input/train_masks/ | wc -l')
#get_ipython().system(u'ls ../input/test/ | wc -l')


# For example, train filenames looks like


#get_ipython().system(u'ls ../input/train/ | grep c_01.jpg')
